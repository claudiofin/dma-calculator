export const es = {
    ...
    disclaimer_vat: '⚠️ IVA excluido: Esta calculadora no incluye el IVA. El IVA se paga por separado y varía por país UE (19-27%). Esto no cambia qué modelo (IAP vs External) es más conveniente.',
