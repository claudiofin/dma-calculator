export const en = {
    ...
    savings_comparison_external: 'Savings vs IAP Standard using your selected External model',
    savings_comparison_iap: 'No savings - you are already using IAP Standard',
    ...
    disclaimer_vat: '⚠️ VAT excluded: This calculator does not include VAT in its calculations. VAT is paid separately and varies by EU country (19-27%). This does not change which model (IAP vs External) is more convenient.',
